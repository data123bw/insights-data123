...
<Tabs color=primary fullWidth=true>
    <Tab label="Murder- 337 cases">
      ...
      In 2024, 337 murder cases were recorded — the highest in the six-year period under review. **Most murders occurred at night (59.9%)**, with Friday to Sunday accounting for 58.2% of all incidents. **Saturday was the single peak day with 86 cases (25.5% of all murders).** December was the peak month with 43 incidents (12.8%).
...
<Alert status=error>
  **Trafficking is the only offence where perpetrators are more likely to be employed.** 35.7% employed versus unemployment rates of 61–91% seen across all other serious crime categories. This suggests more organised criminal networks requiring intelligence-led investigation rather than standard policing approaches.
</Alert>
